...
//### html5 video tag method/properties   
...
function skip(){
    /** dataset
     * first learn at lecture 03 CSS variables 
     */
...
function scrub(e){
    /* learn offsetX
    : offsetX value is progress elements positioned ralative, when you clicked
...
/**
 * ### same as above line
 * *** learn explain : hijacking the fact that we can use '&&' 
